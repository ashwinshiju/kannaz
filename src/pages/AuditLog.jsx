...
import ReimbursementDialog from '@/components/reimbursement/ReimbursementDialog';
...
export default function AuditLog() {
  ...
  return (
    <div>
      ...
      >
        {canManage && (
          <Button variant="outline" className="gap-2" onClick={() => setReimbOpen(true)}>
      ...
      {canManage && <ReimbursementDialog open={reimbOpen} onOpenChange={setReimbOpen} />}
    </div>
  );
}